...
class ReserveAppointmentForm(forms.ModelForm):
    ...
    #     # بررسی وجود تاریخ در choices
    #     valid_dates = [choice[0] for choice in self.fields['selected_date'].choices]
    #     if selected_date_str not in valid_dates:
    #         raise forms.ValidationError("تاریخ انتخاب شده معتبر نیست.")
